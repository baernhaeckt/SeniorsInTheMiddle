...
PII_TYPE_MAPPINGS: dict[str, PiiMapping] = {
    ...
    "PHONE_NUMBER": PiiMapping(
        ...
        faker=lambda: faker.phone_number(),
    ),
    "ADDRESS": PiiMapping(
    ...
    "US_DRIVERS_LICENSE_NUMBER": PiiMapping(
        ...
        faker=lambda: faker.license_plate(),
    ),
    "CREDIT_CARD_NUMBER": PiiMapping(
        ...
        faker=lambda: faker.credit_card_number(card_type=None)
    ),
    ...
    "LOCATION": PiiMapping(
        ...
        faker=lambda: faker.street_address(),
    ),
    "US_PASSPORT_NUMBER": PiiMapping(
        ...
        faker=lambda: faker.passport_number(),
    ),
    "AGE": PiiMapping(
        ...
        faker=lambda: str(faker.random_int(min=0, max=100))
    ),
    "PERSON": PiiMapping(
    ...
    "MAC_ADDRESS": PiiMapping(
        ...
        faker=lambda: faker.mac_address()
    ),
    "US_MBI": PiiMapping(
