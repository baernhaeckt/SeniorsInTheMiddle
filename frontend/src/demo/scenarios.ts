...
export const PASSTHROUGH: PlainRequest[] = [
  { ...TABLET, method: 'GET', host: 'cdn.helsana-app.ch', path: '/assets/app.9f2c1a.css', contentType: 'text/css', bytes: 0, responseBytes: 41208, status: 200, reason: 'text/css' },
  { ...TABLET, method: 'GET', host: 'fonts.gstatic.com', path: '/s/ibmplexsans/v14/zYX9KVElMYYaJe8b.woff2', contentType: 'font/woff2', bytes: 0, responseBytes: 28704, status: 200, reason: 'font/woff2' },
  { ...PHONE, method: 'GET', host: 'cdn.assistant.ch', path: '/assets/vendor.8ab1f0.js', contentType: 'application/javascript', bytes: 0, responseBytes: 214881, status: 200, reason: 'application/javascript' },
  { ...TABLET, method: 'GET', host: 'static.bern.ch', path: '/img/wappen.svg', contentType: 'image/svg+xml', bytes: 0, responseBytes: 3112, status: 200, reason: 'image/svg+xml' },
  { ...LAPTOP, method: 'GET', host: 'app.postfinance.ch', path: '/favicon.ico', contentType: 'image/x-icon', bytes: 0, responseBytes: 5430, status: 200, reason: 'image/x-icon' },
  { ...LAPTOP, method: 'GET', host: 'cdn.medi24.ch', path: '/img/hero@2x.webp', contentType: 'image/webp', bytes: 0, responseBytes: 88204, status: 200, reason: 'image/webp' },
  { ...TABLET, method: 'GET', host: 'tiles.swisstopo.ch', path: '/1.0.0/pixelkarte/12/2145/1436.jpeg', contentType: 'image/jpeg', bytes: 0, responseBytes: 24118, status: 200, reason: 'image/jpeg' },
  { ...PHONE, method: 'GET', host: 'cdn.assistant.ch', path: '/fonts/inter-var.woff2', contentType: 'font/woff2', bytes: 0, responseBytes: 44120, status: 200, reason: 'font/woff2' },
  { ...TABLET, method: 'GET', host: 'cdn.helsana-app.ch', path: '/assets/icons.sprite.svg', contentType: 'image/svg+xml', bytes: 0, responseBytes: 12988, status: 200, reason: 'image/svg+xml' },
  { ...LAPTOP, method: 'GET', host: 'app.postfinance.ch', path: '/assets/runtime.4d1c.js', contentType: 'application/javascript', bytes: 0, responseBytes: 9204, status: 200, reason: 'application/javascript' },
  { ...PHONE, method: 'GET', host: 'cdn.assistant.ch', path: '/assets/theme.dark.css', contentType: 'text/css', bytes: 0, responseBytes: 18440, status: 304, reason: 'text/css' },
  { ...TABLET, method: 'GET', host: 'static.bern.ch', path: '/fonts/frutiger-roman.woff2', contentType: 'font/woff2', bytes: 0, responseBytes: 31002, status: 200, reason: 'font/woff2' },
]

/** Bodies the proxy did open and found nothing worth holding back. */
export const CLEAN: PlainRequest[] = [
  { ...TABLET, method: 'GET', host: 'api.sbb.ch', path: '/v2/departures?station=Bern', contentType: 'application/json', bytes: 0, responseBytes: 8812, status: 200, reason: 'no identifiers' },
  { ...PHONE, method: 'POST', host: 'api.assistant.ch', path: '/v1/telemetry', contentType: 'application/json', bytes: 148, responseBytes: 2, status: 204, reason: 'no identifiers' },
  { ...LAPTOP, method: 'GET', host: 'api.srf.ch', path: '/v1/weather?region=espace-mittelland', contentType: 'application/json', bytes: 0, responseBytes: 4410, status: 200, reason: 'no identifiers' },
  { ...TABLET, method: 'POST', host: 'api.helsana-app.ch', path: '/v1/session/heartbeat', contentType: 'application/json', bytes: 96, responseBytes: 2, status: 204, reason: 'no identifiers' },
  { ...PHONE, method: 'GET', host: 'api.assistant.ch', path: '/v1/models', contentType: 'application/json', bytes: 0, responseBytes: 1204, status: 200, reason: 'no identifiers' },
  { ...LAPTOP, method: 'GET', host: 'api.postfinance.ch', path: '/v3/rates/chf', contentType: 'application/json', bytes: 0, responseBytes: 640, status: 200, reason: 'no identifiers' },
]
