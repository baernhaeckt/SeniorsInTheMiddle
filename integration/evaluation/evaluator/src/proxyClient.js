/**
 * Taken from ../../sender/src/proxyClient.js unchanged but for the capture limit. The
 * evaluator has to reach the proxy exactly the way the sender does, and a second
 * hand-written implementation of the same two request shapes would be a second thing to
 * get wrong rather than a second opinion.
 *
...
// A whole document comes back inside the answer, and the contact list alone is 13 kB of
// it. Generous on purpose: a truncated response would look like a restoration failure.
const MAX_CAPTURE = 4_194_304
