...
/// <param name="Facts">What the detector says about this kind of value.</param>
public record TokenReplacement(Token Token, string AnonymizedValue, int Position, int Length, double Score, TokenFacts Facts);
